...
var Title = function Title(_ref) {
  ...
  return React.createElement("div", null, React.createElement("div", null, React.createElement("h1", null, "to-do (", todoCount, ")")));
};
...
var TodoForm = function TodoForm(_ref2) {
  ...
  return React.createElement("form", { onSubmit: function onSubmit(e) {
      ...
      addTodo(input.value);
      input.value = '';
    } }, React.createElement("input", { className: "form-control new-todo col-md-12", ref: function ref(node) {
      input = node;
...
var Todo = function Todo(_ref3) {
  ...
  // Each Todo
  return React.createElement("a", { href: "#", className: "list-group-item", onClick: function onClick() {
      remove(todo.id);
    } }, todo.text);
};
...
var TodoList = function TodoList(_ref4) {
  ...
  return React.createElement("div", { className: "list-group todo-list", style: { marginTop: '30px' } }, todoNode);
};
...
var TodoApp = function (_React$Component) {
  ...
  _createClass(TodoApp, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", null, React.createElement(Title, { todoCount: this.state.data.length }), React.createElement(TodoForm, { addTodo: this.addTodo.bind(this) }), React.createElement(TodoList, {
